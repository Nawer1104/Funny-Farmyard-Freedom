...
public class Sheep : MonoBehaviour
{
    ...
    {
        if (collision != null && collision.gameObject.CompareTag("Sheep") || collision != null && collision.gameObject.CompareTag("Wall"))
        {
            ReSetPos();
        }
        else if (collision != null && collision.gameObject.CompareTag("Target"))
        {
            Success();
